...
|[FileSystemItemList](addons/godot-next/gui/file_system_item_list.gd)|Creates a vertical list of files or directories that can be added or removed. Supplemental array type hints for files, folders, and resources.|GDScript
